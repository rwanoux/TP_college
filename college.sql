...
--
-- Host: localhost:3306
-- Generation Time: Jul 27, 2021 at 06:59 AM
...
INSERT INTO `classes` (`code_classe`, `nom_classe`, `code_prof_ref_classe`) VALUES
(23, '6a', 114),
(24, '6b', 58),
(25, '6c', 117),
(26, '6d', 68),
...
INSERT INTO `cours` (`code_cour`, `nom_cour`, `code_matiere_cour`) VALUES
(21, ' Le féminin des adjectifs qualificatifs', 1),
(22, ' Les homonymes et les paronymes', 1),
(23, ' Prendre des notes', 1),
(24, ' L\'adjectif épithète', 1),
(25, ' Les noms masculins terminant par -e', 1),
(26, ' Les homophones grammaticaux C\' et S\'', 1),
(27, ' La conjugaison de l\'imparfait de l\'indicatif', 1),
(28, 'vocabulaire valorisant ou dévalorisant', 1),
(29, ' La méthode pour la dictée', 1),
(30, ' L\'accord de l\'adjectif qualificatif ', 1),
(31, ' Statistiques : effectifs, moyenne, fréquences, diagrammes\r\n', 2),
(32, ' Cylindres de révolution', 2),
(33, ' Calculs statistiques : effectifs et fréquences', 2),
(34, ' Somme des angles d\'un triangle', 2),
(35, ' Proportionnalité : généralités', 2),
(36, ' Comparer et décomposer une fraction', 2),
(37, ' Agrandissement et réduction : effets sur les aires et volumes', 2),
(38, ' Les formules de distributivité', 2),
(39, ' La vie courante britannique : institutions et symboles', 3),
(40, ' La phrase interrogative', 3),
(41, ' Le prétérit simple', 3),
(42, ' Le present perfect avec les adverbes ever, yet, never, already', 3),
(43, ' Le futur avec will', 3),
(44, ' La vie courante aux États-Unis : institutions et symboles', 3),
(45, ' Ecrire une lettre', 3),
(46, ' Téléphoner', 3),
(47, ' Le present perfect simple', 3),
(48, ' Le superlatif', 3),
(49, ' La France : une république démocratique', 4),
(50, ' Les grandes phases de la Première Guerre mondiale 1914-1918', 4),
(51, ' Étude de cas : la guerre du Pacifique', 4),
(52, ' La fin de la Guerre Froide', 4),
(53, ' L\'évolution d\'une entreprise : l\'exemple de Peugeot', 4),
(54, ' Histoire des arts : Lord of War (2005)', 4),
...
(57, ' La décolonisation de l\'Inde', 4),
(58, ' La crise de mai 1968', 4),
(59, ' La sécurité routière', 5),
(60, ' Le citoyen : droits et devoirs\r\n', 5),
(61, ' La prévention des risques majeurs', 5),
(62, ' Les libertés individuelles et collectives', 5),
(63, ' La défense nationale et la sécurité collective', 5),
(64, ' Le droit de vote', 5),
(65, ' Comment agir solidairement pour le développement durable ?', 5),
(66, ' Nationalité, citoyenneté française et citoyenneté européenne', 5),
(67, ' La France dans le monde', 5),
(68, ' L\'engagement politique et social', 5),
(69, 'Chanter une mélodie simple avec une intonation juste', 8),
(70, 'Interpréter un chant avec expressivité.', 8),
(71, 'Décrire et comparer des éléments sonores.', 8),
(72, 'Comparer des musiques et identifier des ressemblances et des différences.', 8),
(73, 'Imaginer des représentations graphiques ou corporelles de la musique', 8),
(74, 'Inventer une organisation simple à partir de différents éléments sonores.', 8),
(75, 'Exprimer ses émotions, ses sentiments et ses préférences.', 8),
(76, 'Écouter et respecter l’avis des autres et l’expression de leur sensibilité.', 8),
(77, ' Planning de réalisation', 7),
(78, ' Outils et machines', 7),
(79, ' Propriétés des matériaux', 7),
(80, ' La chaîne d\'énergie', 7),
(81, ' Rechercher des informations', 7),
(82, ' La modélisation numérique', 7),
(83, ' Les fonctions assurées par un objet technique', 7),
(84, ' Outils de base', 7),
(85, ' La propriété intellectuelle', 7),
(86, ' La représentation d\'un objet technique', 7),
(107, 'Performance expliquée de Joseph Beuys : I like America and America likes Me', 9),
(108, 'Analyse de « Persepolis » de Marjane Satrapi', 9),
(109, 'Friedensreich Hundertwasser, artiste écologiste engagé', 9),
(110, 'Analyse de The Tower Poppies de Paul Cummins et Tom Piper', 9),
(111, 'Art et panneaux signalétiques', 9),
(112, 'Sticker Art et Street Art – l’art à proximité du public', 9),
(113, 'Du Pop Art au Pixel Art', 9),
(114, 'Des pixels dans l’histoire de l’art – De la mosaïque au Pixel Art ', 9),
(115, 'Le Land Art, un partenariat entre l’art et le paysage', 9),
(116, 'L’expressionnisme allemand en vidéo', 9),
(117, 'Volley-ball,', 10),
(118, 'hand-ball', 10),
(119, 'musculation', 10),
(120, 'gymnastique ', 10),
...
(123, 'danse', 10),
(124, 'natation', 10),
(125, 'boxe française', 10),
(126, 'étirements (stretching', 10),
(127, ' États de l\'eau', 11),
(128, ' Détermination de la résistance d\'un conducteur ohmique', 11),
(129, ' Loi concernant l\'intensité dans un circuit en dérivation', 11),
(130, ' Masse et volume au cours d\'un changement d\'état', 11),
(131, ' L\'énergie cinétique', 11),
(132, ' Loi concernant l\'intensité dans un circuit en série', 11),
(133, ' Rôle du conducteur ohmique dans un circuit en série', 11),
(134, ' Utilisation de la vitesse de la lumière : distances dans l\'univers', 11),
(135, ' Sens du courant électrique', 11),
(136, ' Circuit en série : place et nombre de dipôles', 11),
(137, ' Le présent des auxiliaires, des verbes de modalité et du verbe « wissen »', 12),
(138, ' Quelques Allemands célèbres', 12),
(139, ' La déclinaison des déterminants', 12),
(140, ' L\'expression du temps', 12),
(141, ' Poser des questions et y répondre', 12),
(142, ' La déclinaison des déterminants', 12),
(143, ' L\'expression du lieu', 12),
(144, ' L\'expression de la possession', 12),
(145, ' L\'adjectif épithète', 12),
(146, ' Les pronoms relatifs', 12);
